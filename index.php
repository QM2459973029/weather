...
<html>
    ...
    <head>
        <meta charset="UTF-8">
        <title>HTML5扁平化天气预报卡片式SVG特效动画展示代码</title>
        <meta name="keywords" content="HTML5扁平化,天气预报,卡片式,SVG特效动画,展示代码" />
                ...
                <div id="card" class="weather">
                    ...
                    <div class="details">
                        <div class="temp">
                            ...
                            <div class="city">含山</div>
							 <span style="position:absolute;margin-left:140px;margin-top:-60px;">
                                湿度
                            </span>
							 <span style="position:absolute;margin-left:190px;margin-top:-60px;">
                               55%
                            </span>
